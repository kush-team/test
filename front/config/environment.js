...
module.exports = function(environment) {
  var ENV = {
    ...
    APP: {
      emberDataSails:  {
        ...
        host: 'http://irreverisble.cc:1337',
  ...
  if (environment === 'development') {
    ...
    ENV['adapter'] = {
      'host': 'http://irreverisble.cc:1337',
      'namespace': 'api',
      'fileUrl': 'http://irreverisble.cc:1337/',
      'upload': 'http://irreverisble.cc:1337/upload-file',      
    };
    ...
    ENV['simple-auth'] = {
      ...
      crossOriginWhitelist: ['http://irreverisble.cc:1337'],
    ...
    ENV['simple-auth-token'] = {
      serverTokenEndpoint: 'http://irreverisble.cc:1337/auth/login',
  ...
  if (environment === 'production') {
    ...
    ENV['contentSecurityPolicy'] = {
        ...
        'script-src': "*",
        'font-src': "*",
        'connect-src': "'self' http://irreverisble.cc:1337 ws://irreversible.cc:1337/ ws://irreversible.cc:35729/livereload http://nominatim.openstreetmap.org/",
        'img-src': "*",
        'style-src': "*",
        'media-src': "*",
        'report-uri': 'http://irreversible.cc'
